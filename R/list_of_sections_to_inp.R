#' Reads input data which was checked for completeness and converts/processes them to an object of class inp.
#'
#' @keywords internal 
list_of_sections_to_inp <- function(list_of_sections, 
                                    infiltration, 
