...
# "C:\Users\dominik\Documents\EPA SWMM Projects\Examples\Example1.inp"
# and substitute your user name.
inp_file <- "/Users/dominik/EPA_SWMM_Projects/Examples/Example1.inp"
...
```{r optim}
  ...
  calibration_res <- DEoptim(
    ...
    control = list(
      ...
      parallelType = 1 # to use all available cores
    ),
    inp = inp, # 'inp' object
